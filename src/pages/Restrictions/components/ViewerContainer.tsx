...
import { RestrictionsMapLegend } from './MapLegend'
...
interface RestrictionsViewerContainerProps {
  showDesktopVariant: boolean
}

export const RestrictionsViewerContainer = ({
  showDesktopVariant,
  ...otherProps
}: RestrictionsViewerContainerProps) => {
    ...
    <>
      {!showDesktopVariant ? (
        ...
        <StyledViewerContainer
          ...
          bottomRight={<Zoom />}
          topRight={<RestrictionsMapLegend />}
        />
      )}
    </>
  )
