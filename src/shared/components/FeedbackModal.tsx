...
const FEEDBACK_RECIPIENT = 'stadslogistiek@utrecht.nl'
const FEEDBACK_SUBJECT = `Terugmelding kaart.nationaalwegenbestand.nl/bereikbaarheid`
...
const QUESTION_RECIPIENT = 'stadslogistiek@utrecht.nl'
const QUESTION_SUBJECT = `Probleem melden of suggestie voor kaart.nationaalwegenbestand.nl/bereikbaarheid`
